...
gl.set_preprocessWordVector_path("/data/ylx/ylx/data/")
...
train_data_path=gl.get_preprocessWordVector_path()
...
#预处理
ques_train, rela_train,label_train, ques_test, rela_test, label_test,wd_idx=preprocess_all_words(train_data_path,train_rela_files,train_ques_file,train_label_file,test_rela_files,test_ques_file,test_label_file,preprocessWordVector_path,preprocessWordVector_files)
